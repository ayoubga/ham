...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/HNkzuP2 **")
...
client.on('message', message => {
    ...
    .setThumbnail("  https://discordapp.com/oauth2/authorize?client_id=510965029823315969&scope=bot&permissions=36760572")        
 message.channel.sendEmbed(embed);
   }
});
